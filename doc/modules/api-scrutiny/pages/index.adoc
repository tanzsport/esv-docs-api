...
==== Rückgabe Veranstaltung (Gesamt-Starterliste analog ohne Namen)
...
Nachmeldeerlaubnis [nachmeldungen]; NULL in Gesamt-Starterliste
...
für eine Wettbewerbsart) [meldungen]
...
* Array Skatingtabelle (optional bzw. nur sofern nötig, Reihenfolge aus
...
* Array über alle WR (in der Reihenfolge wie im Ergebnisupload)
